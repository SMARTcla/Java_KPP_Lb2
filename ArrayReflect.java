...
public class ArrayReflect {//task 4
    ...
    public static void main(String... args) throws ClassNotFoundException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
        ...
        System.out.println("Initialize the array manually? (Y/N): ");
    ...
    public static void menu(){
        System.out.println("1.Change size");//изменить размер
        System.out.println("2.Show");//распечатать
        System.out.println("3.Exit");//выйти
        System.out.println("--------------------------");
    }
